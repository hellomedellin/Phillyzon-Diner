...
export default function PromotionsPage() {
  ...
  return (
    <PublicLayout>
      <div className="py-12 md:py-20 px-4 film-grain" data-testid="page-promotions">
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          {isLoading ? (
                ...
                <Card key={promo.id} className="p-0 overflow-visible hover-elevate" data-testid={`card-promo-${promo.id}`}>
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-6">
                      ...
                      <p className="text-foreground/50 mb-4 italic" data-testid={`text-promo-desc-${promo.id}`}>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-foreground/40 italic font-serif text-lg" data-testid="text-promo-empty">
                {t("promo.empty")}
              </p>
            </div>
          )}
