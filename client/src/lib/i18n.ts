...
const translations: TranslationMap = {
  ...
  "admin.settings": { en: "Account", es: "Cuenta" },
  "admin.settings.title": { en: "Account Settings", es: "Configuracion de Cuenta" },
  "admin.settings.currentEmail": { en: "Current Email", es: "Correo Actual" },
  "admin.settings.newEmail": { en: "New Email", es: "Nuevo Correo" },
  "admin.settings.currentPassword": { en: "Current Password", es: "Contrasena Actual" },
  "admin.settings.newPassword": { en: "New Password", es: "Nueva Contrasena" },
  "admin.settings.confirmPassword": { en: "Confirm New Password", es: "Confirmar Nueva Contrasena" },
  "admin.settings.saveChanges": { en: "Save Changes", es: "Guardar Cambios" },
  "admin.settings.passwordMismatch": { en: "New passwords do not match", es: "Las contrasenas no coinciden" },
  "admin.settings.noChanges": { en: "No changes to save", es: "Sin cambios para guardar" },
  "admin.settings.success": { en: "Account updated successfully", es: "Cuenta actualizada correctamente" },
